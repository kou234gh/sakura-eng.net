...
import { sakuraEng } from "../../../../assets/img";
import { sakuraEngTitle } from "../../../../assets/img";
...
export const Footer = () => {
  ...
  return (
    <>
      <MailForm />
      <div className="w-[100vw] p-4 bg-inherit blur-l md:p-6 hidden">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center">
              <img src={sakuraEng} className="h-8 mr-3" alt="Sakura Engineering Logo" />
              {/* <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span> */}
              <img src={sakuraEngTitle} className="" alt="Sakura Engineering" />
            </a>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://sakura-eng.net/" className="hover:underline">桜エンジニアリング</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://github.com/kou234gh" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
